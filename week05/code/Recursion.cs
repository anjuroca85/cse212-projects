...
public static class Recursion
{
    ...
    {
        // Initializing the dictionary on the 1st call if it is null
        if (remember == null)
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        //I will grab everything b4 the wildcard with ..index and then everything after the wildcard with index + 1
    ...
    public static void SolveMaze(List<string> results, Maze maze, int x = 0, int y = 0, List<ValueTuple<int, int>>? currPath = null)
    {
        ...
        // ADD CODE HERE
        // I need to create a boundary and wall check to find out if I am out of bounds or hitting a wall
        ...
        //Base case: Have I reached the end of the maze?
        if (maze.IsEnd(x, y))
        {
